...
# अपने ऐप के मॉडल इम्पोर्ट करें (अगर ऐप का नाम 'shop' नहीं है, तो उसे बदल लें)
from shop.models import Category, Product, Stock 

class Command(BaseCommand):
    help = 'SQLite डेटाबेस में 100 प्रोडक्ट्स का डमी डेटा लोड करने के लिए'

    def handle(self, *args, **kwargs):
        self.stdout.write(self.style.WARNING("⏳ डेटाबेस में 100 प्रोडक्ट्स लोड हो रहे हैं..."))

        # 100 रियलिस्टिक प्रोडक्ट्स का रॉ डेटा
        raw_products = [
            ...
            {"title": "Bombay Dyeing Pure Cotton Double Bedsheet", "cat": "Home & Kitchen", "sub": "Bedding", "price": 1299, "brand": "Bombay Dyeing"},
            ...
            {"title": "Usha Fontana Lotus 1230mm Ceiling Fan", "cat": "Home & Kitchen", "sub": "Appliances", "price": 7500, "brand": "Usha"},
            ...
            {"title": "Fossil Gen 6 Smartwatch Smoke Stainless", "cat": "Fashion", "sub": "Watches", "price": 18495, "brand": "Fossil"},
            ...
            {"title": "American Tourister 79cm Hard Suitcase", "cat": "Fashion", "sub": "Bags & Luggage", "price": 4800, "brand": "American Tourister"},
            {"title": "Wildcraft 35L Casual Backpack", "cat": "Fashion", "sub": "Bags & Luggage", "price": 1699, "brand": "Wildcraft"},
            {"title": "Allen Solly Men's Cotton Formal Shirt", "cat": "Fashion", "sub": "Men Clothing", "price": 1499, "brand": "Allen Solly"},
            ...
            {"title": "L'Oreal Paris Total Repair 5 Shampoo 1L", "cat": "Beauty & Care", "sub": "Hair Care", "price": 650, "brand": "L'Oreal"},
            ...
            {"title": "Nivea Soft Light Moisturizer Cream 300ml", "cat": "Beauty & Care", "sub": "Skin Care", "price": 399, "brand": "Nivea"},
            ...
            {"title": "Khadi Natural Herbal Hair Cleanser Amla", "cat": "Beauty & Care", "sub": "Hair Care", "price": 220, "brand": "Khadi Natural"},
            {"title": "Plum Green Tea Pore Cleansing Face Wash", "cat": "Beauty & Care", "sub": "Skin Care", "price": 345, "brand": "Plum"},
            ...
            {"title": "Dove Cream Beauty Bathing Bar Set of 5", "cat": "Beauty & Care", "sub": "Skin Care", "price": 380, "brand": "Dove"},

            # --- Category: Sports & Fitness ---
            {"title": "Yonex Nanoray Light 18i Badminton Racket", "cat": "Sports", "sub": "Badminton", "price": 2150, "brand": "Yonex"},
            ...
            {"title": "Cosco Light Cricket Tennis Ball Pack of 6", "cat": "Sports", "sub": "Cricket", "price": 450, "brand": "Cosco"},
            {"title": "SG Scorer Classic Leather Cricket Ball", "cat": "Sports", "sub": "Cricket", "price": 380, "brand": "SG"},
            {"title": "Boldfit Yoga Mat Premium 6mm Thickness", "cat": "Sports", "sub": "Yoga", "price": 799, "brand": "Boldfit"},
            ...
            {"title": "Giono Mountain Terrain Bicycle 21-Speed", "cat": "Sports", "sub": "Outdoor Gym", "price": 16800, "brand": "Giono"},
        ...
        # SQLite की स्पीड बढ़ाने के लिए सभी ऑपरेशन्स को एक Transaction में चलाएंगे
        with transaction.atomic():
            for index, p_data in enumerate(raw_products, 1):
                ...
                product = Product.objects.create(
                    ...
                    image="products/sample_product.jpg", # डमी इमेज पाथ
        ...
        self.stdout.write(self.style.SUCCESS(f"🎉 बधाई हो दीपक जी! सभी 100 प्रोडक्ट्स SQLite डेटाबेस में लोड हो गए हैं।"))